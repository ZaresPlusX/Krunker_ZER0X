        ...
        function cTX() {
            if (!cDR['singlePlayer'] && (cDT && cDT['active'] || spectating))
                for (var cCd = 0x0; cCd < cDR['players']['list']['length']; ++cCd)
                    ...
                    !spectating && !(cEn && cEn == cDV['team']) && !(cEn && cEn != cDV['team'] && cDR['mode']['teamSee'] && cDR['mode']['teamSee'][0x0] == cEn && cDR['mode']['teamSee'][0x1] == cDV['team']) && (cDR['config']['nameTags'] || cDR['mode']['hideNames'] || null != cDR['oMrVwggATjTbztEKMbtPRvJVGIdzONwA'](cDT, cDV['x'], cDV['y'], cDV['z'])) && (#8FCC2CcDV['vYRDHNtoczWxPcpbhghRyYnBdehThUaq'] = !0x1),
